    ...
    return (
        <div className='flex w-full h-auto bg-[#ebebeb] py-8 mb-5 justify-center items-center'>
            <div className="flex w-10/12 h-auto">
                <div className={`flex w-7/12 ${showAllDescription ? 'h-auto' : 'h-72'} gap-y-4 overflow-hidden flex-col rounded-sm relative`}>
                    <div className="flex text-xl font-bold">Worker</div>
                    <div className="flex text-base font-semibold text-purple-500 underline">Ramcy</div>
                    <div className="flex gap-x-3">
                        <div className="flex w-28 h-28 rounded-full bg-black">
                        </div>
                        <div className="flex h-full justify-center gap-y-1 flex-col">
                            <div className="flex text-sm gap-x-2 items-center">
                                <MdOutlineStarOutline size={18.5}/>
                                <div className="flex">4.7 Profile rating</div>
                            </div>
                            <div className="flex text-sm gap-x-2 items-center">
                            ...
                            <div className="flex text-sm gap-x-2 items-center">
                                ...
                                <div className="flex">ishara@gmail</div>
                            </div>
                            <div className="flex text-sm gap-x-2 items-center">
                                <MdOutlineLocalPhone size={16}/>
                                <div className="flex">0789365102</div>
                            </div>
                        </div>
                    </div>
